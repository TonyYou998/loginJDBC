...
<body class="layout-login">
    ...
    <div class="layout-login__form bg-white" data-perfect-scrollbar>
        ...
        <form action="<c:url value="<%=UrlConst.LOGIN %>" />" method="post">
            ...
            <div class="form-group mb-5">
                <div class="custom-control custom-checkbox">
                    <input type="checkbox" name="rememberLogin" class="custom-control-input" checked="" id="remember">
                    <label class="custom-control-label" for="remember">Remember me</label>
                </div>
            </div>
            <div class="form-group text-center">
                <button class="btn btn-primary mb-5" type="submit">Login</button><br>
                <a href="<c:url value="<%=UrlConst.FORGOT_PASSWORD %>" />" >Forgot password?</a> <br> Don't have an account? <a class="text-body text-underline" href="<c:url value="<%=UrlConst.SIGNUP %>" />">Sign up!</a>
            </div>
        </form>
    </div>
